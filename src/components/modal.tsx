          ...
          >
            <div className="flex items-center justify-between border-b border-bone px-6 py-4">
              ...
              <button
                ...
                onClick={onClose}
                aria-label="Close"
                className="flex h-11 w-11 items-center justify-center rounded-full text-fog transition-colors hover:bg-cloud hover:text-graphite focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-apple-blue"
              >
