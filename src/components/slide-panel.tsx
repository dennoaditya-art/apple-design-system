        ...
        <>
          ...
          >
            <div className="flex items-center justify-between border-b border-silver px-6 py-4">
              <h2 className="font-font-heading text-[20px] font-semibold leading-[1.2] text-ink">
                {title}
              </h2>
              <button
                type="button"
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full transition-colors hover:bg-fog focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
              >
