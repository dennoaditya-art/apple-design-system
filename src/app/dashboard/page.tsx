...
const RECENT_ORDERS = [
  { id: "#ORD-001", customer: "Alice Johnson", product: "UltraPhone X", amount: "$1,199", status: "Completed" as const },
  { id: "#ORD-002", customer: "Bob Smith", product: "Laptop Pro 14\"", amount: "$2,499", status: "Processing" as const },
  { id: "#ORD-003", customer: "Carol Davis", product: "Earbuds Pro 2", amount: "$249", status: "Completed" as const },
...
const TOP_PRODUCTS = [
  ...
  { name: "Laptop Pro 14\"", revenue: "$37,485", units: 15, trend: "up" as const },
  { name: "Earbuds Pro 2", revenue: "$12,450", units: 50, trend: "up" as const },
  { name: "Tablet Pro", revenue: "$8,991", units: 9, trend: "down" as const },
  { name: "Watch Ultra 2", revenue: "$7,192", units: 9, trend: "up" as const },
]
