            ...
            <div className="mb-6 flex flex-wrap justify-center gap-2">
              {CATEGORIES.map((cat) => (
                <button
                  ...
                  className={`rounded-full px-4 py-2 font-sf-pro-text text-[13px] leading-[1.38] transition-all focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-apple-blue ${
